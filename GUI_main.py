...
root.title("Employement Recommedation System")
...
#
label_l1 = tk.Label(root, text="Employement Recommedation System",font=("Times New Roman", 35, 'bold'),
...
# button4 = tk.Button(root, text="Admin_Login", command=a_log, width=14, height=1,font=('times', 20, ' bold '), bg="#152238", fg="white")
